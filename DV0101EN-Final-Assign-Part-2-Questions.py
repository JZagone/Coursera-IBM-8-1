...
@app.callback(
    ...
    Input(component_id='dropdown-statistics',component_property='Yearly-Statistics'))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        unemp_data = recession_data.groupby(['unemployment_data','Vehicle_Type'])['Automobile_Sales'].mean().reset_index()
